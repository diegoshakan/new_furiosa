...
ActiveRecord::Schema[8.0].define(version: 2025_04_07_133301) do
  ...
  create_table "announcements", force: :cascade do |t|
    ...
    t.index ["subcategory_id"], name: "index_announcements_on_subcategory_id"
  ...
  add_foreign_key "announcements", "subcategories"
